...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SubscriptionPost'
        db.create_table('rc_subscriptionpost', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rc.Post'])),
            ('subscription', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rc.Subscription'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('rc', ['SubscriptionPost'])


    def backwards(self, orm):
        # Deleting model 'SubscriptionPost'
        db.delete_table('rc_subscriptionpost')
    ...
    models = {
        ...
        'rc.subscription': {
            'Meta': {'ordering': "['-last_sent']", 'object_name': 'Subscription'},
